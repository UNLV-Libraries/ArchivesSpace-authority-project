...
console.log("i'm i very far now");
$(function() {

console.log("i'm i very close now");
  $.fn.init_rapid_data_entry_form = function($modal, $node) {
    ...
    $(this).each(function() {
      ...
      $modal.on("click", "#rde_reset", function(event) {
        ...
        // reload the form
        $(document).triggerHandler("qdeload.aspace", [$node, $modal]);
      });
      ...
      var initColumnShowHideWidget = function() {
		...
		console.log("SHOW ME HOW NEAR WE ARE")
    ...
    $("select.selectpicker", $modal).selectpicker();
	  ...
	  console.log("too much brug ")
  $(document).bind("qdeload.aspace", function(event, $node, $modal) {
