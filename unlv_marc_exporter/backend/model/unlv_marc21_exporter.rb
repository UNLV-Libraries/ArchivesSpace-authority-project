class MARCModel < ASpaceExport::ExportModel
  ...
  def handle_ead_loc(ead_loc)
	if( MarcExportSettings.m_export_settings['tag_555'])
		text = if MarcExportSettings.m_export_settings['tag_856_ss_1'].nil? then MarcExportSettings.m_export_settings['tag_856_ss_1'] else  "Finding aid online:" end
		df('555', ' ', ' ').with_sfs(
								['a', text],
								['u', ead_loc]
								)
	...
	if( MarcExportSettings.m_export_settings['tag_856'])
		text = if MarcExportSettings.m_export_settings['tag_856_ss_1'].nil? then MarcExportSettings.m_export_settings['tag_856_ss_1'] else  "Finding aid online:" end
		df('856', '4', '2').with_sfs(
								['a', MarcExportSettings.m_export_settings['tag_856_ss_1']],
								['u', ead_loc]
								)
	end
  end
